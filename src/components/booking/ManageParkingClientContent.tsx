...
// This function and its mock data are now part of the client component
            ...
            <Card className="shadow-xl">
              <CardHeader>
                ...
                <CardDescription className="flex items-center text-base pt-1">
                  <MapPin className="w-5 h-5 mr-2 text-muted-foreground icon-glow" /> {space.facilityAddress}
                </CardDescription>
              </CardHeader>
          ...
          <div className="lg:col-span-5">
            ...
            {canExtend && space.pricePerHour === undefined && (
                <Card className="shadow-xl text-center sticky top-24 bg-muted/50">
                    ...
                    <CardContent className="p-6">
                        <AlertTriangle className="mx-auto h-10 w-10 text-muted-foreground mb-3" />
                        <p className="text-sm text-muted-foreground">Cannot extend parking. Pricing information for this space is currently unavailable.</p>
                    </CardContent>
                </Card>
            )}
          </div>
